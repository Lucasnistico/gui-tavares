        ...
        <section className="about__wrap">
          ...
          <div className="about__title-wrap">
            <p className="about__subtitle">
              ...
              precisa te encontrar! Canta, solta a voz para se ouvir, deixa o
              céu iluminar, salva o samba que chegar.&#127925;&#127926;
            </p>
          ...
          <div className="about__contents">
            <div className="about__content about__content--top">
              ...
              contemporary Brazilian music. His first independent album, Noite
              que Brincou de Lua, released in partnership with Edu Passeto,
              marked the beginning of his recording career and was later
              released by Far Out Records due to the cultural impact it
              achieved.
            </div>
            <div className="about__content">
              ...
              Tribute, Minas Heart of Brazil, and the vocal group Nossa Voz,
              which has over 20 years. Additionally, he promotes lectures and
              workshops on Brazil's musical culture.
            </div>
          </div>
